...
if (config.WORKTYPE == 'public') {
    ...
    if (QueenAmdiCon.user.jid === '@s.whatsapp.net') {
        ...
        await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*✨Philsmagic✨ started in Private Mode👸*\n\n_Please do not try any commands here. This is your log number._\n_You can try commands anywhere else :)_\n\n_Type_ *.panel* _to get your full command list._\n\n_Your bot in Private Mode. To change, use_ ```.setvar WORK_TYPE=public``` _command._\n\n*You can check our website for new features : https://www.amdaniwasa.com/*\n\n* *Thank you for using ✨Philsmagic✨ 💌*', MessageType.text);
    }
}
    else {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI') {
                                await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*-- දෝෂ වාර්තාව [✨Philsmagic✨] --*' + 
                                    '\n\n*✨Philsmagic✨ Bot දෝෂයක් සිදුවී ඇත!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [✨Philsmagic✨] ⚜️*' + 
                                        '\n==== ```දෝෂ නිරාකරණය කර ඇත!``` ====' +
                                ...
                                await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*-- ERROR REPORT [✨Philsmagic✨] --*' + 
                                    '\n\n*✨Philsmagic✨ an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ ERROR ANALYSIS [✨Philsmagic✨] ⚜️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
                                        '\n_You can write to our support groups for more help.https://chat.whatsapp.com/HKWDIBNYUwc1nq80gzu3HN._'
                                        , MessageType.text
                                    );
                                } 
                            }
